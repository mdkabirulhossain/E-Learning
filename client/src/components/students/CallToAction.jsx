...
const CallToAction = () => {
    return (
        <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
            ...
            <p className='text-gray-500 sm:text-sm'>With today’s digital tools, you can explore new skills, grow your expertise, and gain valuable insights from anywhere at any time.</p>
